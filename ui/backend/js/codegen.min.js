...
Optimize(request,response,PGTUNER_SCOPE.DATABASE_CONFIG,tuning_items);if(request.options.enable_database_correction_tuning){correction_tune(request,response);}
...
data_index_disk=new PG_DISK_PERF({'random_iops_spec':5*K10,'random_iops_scale_factor':1.0,'throughput_spec':350,'throughput_scale_factor':1.0,'disk_usable_size':128*Gi,})
wal_disk=new PG_DISK_PERF({'random_iops_spec':8*K10,'random_iops_scale_factor':1.0,'throughput_spec':500,'throughput_scale_factor':1.0,'disk_usable_size':256*Gi,})
kw=new PG_TUNE_USR_KWARGS({user_max_connections:0,superuser_reserved_connections_scale_ratio:1.5,single_memory_connection_overhead:5*Mi,memory_connection_to_dedicated_os_ratio:0.7,effective_cache_size_available_ratio:0.985,shared_buffers_ratio:0.25,max_work_buffer_ratio:0.075,effective_connection_ratio:0.75,temp_buffers_ratio:0.25,max_normal_memory_usage:0.45,mem_pool_tuning_ratio:0.4,hash_mem_usage_level:-5,mem_pool_parallel_estimate:true,max_query_length_in_bytes:2*Ki,max_runtime_ms_to_log_slow_query:2*K10,max_runtime_ratio_to_explain_slow_query:1.5,wal_segment_size:BASE_WAL_SEGMENT_SIZE,min_wal_size_ratio:0.05,max_wal_size_ratio:0.05,wal_keep_size_ratio:0.05,autovacuum_utilization_ratio:0.80,vacuum_safety_level:2,})
options=new PG_TUNE_USR_OPTIONS({enable_sysctl_general_tuning:false,enable_sysctl_correction_tuning:false,enable_database_general_tuning:true,enable_database_correction_tuning:true,workload_type:PG_WORKLOAD.HTAP,workload_profile:PG_SIZING.LARGE,pgsql_version:17,database_size_in_gib:0,num_write_transaction_per_hour_on_workload:50*K10,align_index:1,data_index_spec:data_index_disk,wal_spec:wal_disk,tuning_kwargs:kw,operating_system:'containerd',base_kernel_memory_usage:-1,base_monitoring_memory_usage:-1,vcpu:8,total_ram:8*5*Gi,opt_mem_pool:PG_PROFILE_OPTMODE.OPTIMUS_PRIME,opt_transaction_lost:PG_PROFILE_OPTMODE.NONE,opt_wal_buffers:PG_PROFILE_OPTMODE.SPIDEY,max_time_transaction_loss_allow_in_millisecond:650,max_num_stream_replicas_on_primary:0,max_num_logical_replicas_on_primary:0,max_backup_replication_tool:PG_BACKUP_TOOL.PG_BASEBACKUP,offshore_replication:false,})
