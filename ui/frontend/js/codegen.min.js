...
const effective_cache_size=managed_cache['effective_cache_size'];const wal_throughput=options.wal_spec.perf()[0];const wal05=wal_time(wal_buffers,0.5,_kwargs.wal_segment_size,managed_cache['wal_writer_delay'],wal_throughput,options,managed_cache['wal_init_zero']);const wal10=wal_time(wal_buffers,1.0,_kwargs.wal_segment_size,managed_cache['wal_writer_delay'],wal_throughput,options,managed_cache['wal_init_zero']);const wal15=wal_time(wal_buffers,1.5,_kwargs.wal_segment_size,managed_cache['wal_writer_delay'],wal_throughput,options,managed_cache['wal_init_zero']);const wal20=wal_time(wal_buffers,2.0,_kwargs.wal_segment_size,managed_cache['wal_writer_delay'],wal_throughput,options,managed_cache['wal_init_zero']);let real_autovacuum_work_mem=managed_cache['autovacuum_work_mem'];if(real_autovacuum_work_mem===-1){real_autovacuum_work_mem=managed_cache['maintenance_work_mem'];}
