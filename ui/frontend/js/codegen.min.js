...
this.hardware_scope={'cpu':this.workload_profile,'mem':this.workload_profile,'net':this.workload_profile,'disk':this.workload_profile,'overall':this.workload_profile};if(this.tuning_kwargs.mem_pool_parallel_estimate==='auto'){if([PG_WORKLOAD.HTAP,PG_WORKLOAD.OLTP].includes(this.workload_type)){this.tuning_kwargs.mem_pool_parallel_estimate=true;}else{this.tuning_kwargs.mem_pool_parallel_estimate=false;}}}
