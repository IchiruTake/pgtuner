...
console.log(request.options);console.log(request.options.max_time_transaction_loss_allow_in_millisecond);const after_wal_writer_delay=Math.floor(request.options.max_time_transaction_loss_allow_in_millisecond/3.25)
